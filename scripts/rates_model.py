...
def load_synonymous_muts(subtype=None):
    ...
    Data is loaded from results/site_specific_substitution_rates.csv, which is generated by
    ...
    df = pd.read_csv("results/site_specific_substitution_rates.csv", keep_default_na=False)
